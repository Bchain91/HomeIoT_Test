...
public class MainActivity extends AppCompatActivity {
    static final int REQUEST_CODE_LOGIN_ACTIVITY = 101;
    static Handler mainHandler;

    ClientThread clientThread;
    Fragment1Home fragment1Home;
    Fragment2Control fragment2Control;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment2Control = new Fragment2Control();
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.tab2:
                        ...
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.container, fragment2Control).commit();
    ...
    class MainHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if (bottomNavigationIndex == 2)
                ...
                fragment2Control.recvDataProcess(data);
        }
    }
